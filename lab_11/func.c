...
/**
 «аписывает символ cur_sym в массив символов (строку) format_buffer.
...
/**
 ¬ыполн€ет полную запись аргумента toconvert в виде hex-числа, размера unsigned short int, в строку format_buffer.
...
/**
 ¬ыполн€ет полную запись аргумента toconvert в виде hex-числа, размера unsigned int, в строку format_buffer.
...
/**
 ¬ысчитывает длину записываемого целого числа.
...
/**
  онвертирует цифру записываемого целового числа в символ.
...
/**
 ¬ыполн€ет полную запись аргумента toprint в виде целого числа в строку format_buffer.
...
/**
 ¬ыполн€ет запись аргумента toprint в виде символа в строку format_buffer.
...
/**
 «аписывает в строку buffer аргументы из списка ap в соответствии со спецификаторами и модификатором.

 * @param buffer
 * @param buff_size
 * @param format
 * @param ap
 * @return возвращает длину полученной строки, не учитыва€ заключительный нуль.
 */
